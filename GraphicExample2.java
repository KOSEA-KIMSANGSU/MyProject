...
class DrawingPanel extends JPanel {
	...
	public void paint(Graphics g) {
		...
		g.drawString(" O��:��� ", 300, 150);
		g.drawString(" A��:���� ", 300, 170);
		g.drawString(" B��:�Ķ� ", 300, 190);
		g.drawString(" AB��:�ʷ� ", 300, 210);
		}
